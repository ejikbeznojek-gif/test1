...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Параметры.Вставить("ОценкаПроизводительности", ПараметрыРаботыКлиента);	
...
Процедура ПервоначальноеЗаполнение() Экспорт
	...
	Константы.ОценкаПроизводительностиПериодЗаписи.Установить(10);
...
Функция ПолучитьКомментарийЗамераВремени()
	...
	Возврат ЗначениеВСтрокуВнутр(КомментарийЗамераВремени);
...
Функция СерверныйМодульМенеджера(Имя)
	...
	ЧастиИмени = РазложитьСтрокуВМассивПодстрок(Имя, ".");
...
Функция ЗаписатьВЛогПроизводительности(Сообщение, ВремяОбработки, ДопПараметры = Неопределено) Экспорт
	...
	//Данные.Вставить("ВремяОбработки", ВремяОбработки);
	//Данные = МаркировкаС.СериализоватьВJSON(Данные);
