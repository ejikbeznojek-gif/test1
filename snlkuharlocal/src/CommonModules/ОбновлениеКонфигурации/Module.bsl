//////////////////////////////////////////////////////////////////////////////// 
// Модуль определяет "интерфейс" для обработки ОбновлениеКонфигурации в виде 
// "виртуальных" процедур и функций. Изменению подлежит код процедур и функций
...
Функция АдресСервераДляПроверкиНаличияОбновления() Экспорт
	Возврат "downloads.intertade.ru";
КонецФункции 
...
Функция АдресРесурсовДляПроверкиНаличияОбновления() Экспорт
	Результат = "//V81_Update/Configs/" + КороткоеИмяКонфигурации() + "/";	
