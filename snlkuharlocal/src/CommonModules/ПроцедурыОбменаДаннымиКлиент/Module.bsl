...
//	Исключение
//				
//		СообщитьОбОшибке("Ошибка при получении информации о настройках правил обмена: " + ОписаниеОшибки());
//		Возврат Ложь;
//		
//	КонецПопытки;	
//	
...
Процедура ОбновитьТаблицуНастроекПолейПоиска(ЭтаФорма)
    ...
    Исключение
		...
		// в режиме клиента выводим информацию об ошибке
		СообщитьОбОшибке("Ошибка при получении информации о настройках полей поиска: " + ОписаниеОшибки());
						   
	КонецПопытки;	
	
КонецПроцедуры

Процедура ВыполнитьЗагрузкуИнформацииОВозможныхПоляхПоиска(ЭтаФорма, ПравилаОбмена,ПравилаОбменаДляПриемника = Неопределено, ОбязательноОбновитьТаблицуНастроекИзПравил = Ложь) Экспорт
	//
...
Процедура ОбновитьТаблицуНастроекВыгрузкиДанных(ЭтаФорма) Экспорт
    ...
    Исключение
		...
		// в режиме клиента выводим информацию об ошибке
		СообщитьОбОшибке("Ошибка при получении информации о настройках выгрузки: " + ОписаниеОшибки());
