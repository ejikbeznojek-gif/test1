...
Процедура ЗагрузитьОбработки(ДоступныеОбработки, ВыбранныеОбработки) Экспорт

	Формы = ЭтотОбъект.Метаданные().Формы;

	Для каждого Форма из Формы Цикл
		Если Форма.Имя = "ПодборИОбработка" ИЛИ Форма.Имя = "ФормаНастроек"
			ИЛИ Форма.Имя = "ШаблонОбработки"
			ИЛИ Форма.Имя = "ФормыЗагрузкиОтбораСписком" Тогда
			Продолжить;
		КонецЕсли;
...
// 
Функция пдИнициализацияМенеджеров() Экспорт
...
КонецФункции // пдИнициализацияМенеджеров()

////////////////////////////////////////////////////////////////////////////////
// ОПЕРАТОРЫ ОСНОВНОЙ ПРОГРАММЫ

мМенеджеры = пдИнициализацияМенеджеров();
