...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ОбменТоварами и НЕ ОбменЗаказами
		 Тогда
		
		СообщитьОбОшибке("Должен быть выбран хотя бы один из режимов выгрузки: ""Выгрузка товаров"" или ""Обмен заказами""!", Отказ);
	...
	Если ВыгружатьНаСайт Тогда
		...
		Если Не ЗначениеЗаполнено(HTTPОбменАдресСайта) Тогда
			СообщитьОбОшибке("Не указан WEB - сайт для обмена данными!", Отказ);
		КонецЕсли;
		
	Иначе
		
		Если Не ЗначениеЗаполнено(КаталогВыгрузки) Тогда
			СообщитьОбОшибке("Не указан каталог для обмена данными!", Отказ);
		КонецЕсли;
	...
	Если ВыгружатьТолькоИзменения Тогда
		...
		Если ОбменТоварами И НЕ ЗначениеЗаполнено(УзелОбменаТоварами) ТОгда
			СообщитьОбОшибке("Узел плана обмена для контроля изменений товаров не указан!", Отказ);
		КонецЕсли;
		
		//Если  НЕ ЗначениеЗаполнено(УзелОбменаЗаказами) ТОгда
		//	СообщитьОбОшибке("Узел плана обмена для контроля изменений заказов не указан!", Отказ);
		//КонецЕсли;
