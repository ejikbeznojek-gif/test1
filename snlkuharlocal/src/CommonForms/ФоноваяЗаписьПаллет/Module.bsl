...
Процедура ПриОткрытии(Отказ)
	...
	МодульДлительныеОперацииКлиент = инт_ДлительныеОперацииК;
	...
	Если Параметры.ВыводитьОкноОжидания Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("ПриЗавершенииДлительнойОперации", ЭтаФорма);
		ОповещениеОПрогрессе  = Новый ОписаниеОповещения("ПриПолученииПрогрессаДлительнойОперации", ЭтаФорма);
		
		ПараметрыОжидания = инт_ДлительныеОперацииК.ПараметрыОжидания(ВладелецФормы);
		...
		инт_ДлительныеОперацииК.ОжидатьЗавершение(ДлительнаяОперация, ОповещениеОЗавершении, ПараметрыОжидания);
	КонецЕсли;
...
Процедура ПриПолученииПрогрессаДлительнойОперации(ДлительнаяОперация, ДополнительныеПараметры) Экспорт
	...
	инт_ДлительныеОперацииК.ОбработатьСообщенияПользователю(ДлительнаяОперация.Сообщения,
...
Процедура ПоказатьОповещение()
	...
	инт_ДлительныеОперацииК.ПоказатьОповещение(Параметры.ОповещениеПользователя, ВладелецФормы);
...
Функция ПроверитьИОтменитьЕслиВыполняется(ИдентификаторЗадания, ОтменятьПриЗакрытии)
	...
	ДлительнаяОперация = инт_ДлительныеОперации.ОперацияВыполнена(ИдентификаторЗадания);
...
Процедура ОтменитьВыполнениеЗадания(ИдентификаторЗадания)
	...
	инт_ДлительныеОперации.ОтменитьВыполнениеЗадания(ИдентификаторЗадания);
